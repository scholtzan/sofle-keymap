...
[_LOWER] = LAYOUT(
    ...
    _______, _______,  _______, _______, XXXXXXX, XXXXXXX,                         _______, _______,  KC_UP,   _______,  _______, _______,
    _______, _______, _______, _______, XXXXXXX,  KC_CAPS,                         _______, KC_LEFT,  KC_DOWN, KC_RGHT,   _______,   _______,
    KC_LSFT, KC_UNDO, KC_CUT,  KC_COPY, KC_PASTE, XXXXXXX, _______,       KC_MPLY, XXXXXXX, _______,  XXXXXXX, KC_LEND,   XXXXXXX,  KC_RSFT,
                      KC_LCTRL, KC_LALT, KC_LGUI,KC_ADJUST,KC_ENT,    KC_SPC, KC_ADJUST, KC_RGUI, KC_RALT, KC_RCTRL
),
/* RAISE
 * ,-----------------------------------------.                    ,-----------------------------------------.
...
[_ADJUST] = LAYOUT(
    ...
    CG_TOGG, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX,     XXXXXXX, XXXXXXX, KC_MPRV, KC_MPLY, KC_MNXT, XXXXXXX, XXXXXXX,
                      KC_LCTRL, KC_LALT, KC_LGUI,XXXXXXX,KC_ENT,    KC_SPC, XXXXXXX, KC_RGUI, KC_RALT, KC_RCTRL
)
};
